...
# Uruchom Expo
Write-Host "Uruchamianie Expo (Web + Mobile)..." -ForegroundColor Yellow
...
$expoJob = Start-Job -ScriptBlock {
    ...
    npx expo start --web --port 19006 --yes
}
...
Write-Host "Aby zatrzymac projekt, nacisnij Ctrl+C i uruchom: docker-compose down" -ForegroundColor Yellow
